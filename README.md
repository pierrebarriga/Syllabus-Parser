...
### Improving Performance by Cleaning Text Data
...
Based on how the syllabus is designed, assignments may show up more than twice. Updates to the code could be made so that each row represents an assignment and it's final due date. 

### Expand LLM Coverage 
Since I used Google AI Studio / Gemini during this process, I coded to just accept a Google AI Studio API Key. One could easily update the code, though I think further interactivity would be required to also select the appropriate model. It would be an interesting design issue to solve. 
